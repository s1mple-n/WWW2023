class Developer {
    ...
    public constructor(staticImgUrl: string, isLeader: boolean, name: string, studentId: string, theClass: string, email: string, githubLink: string){
    ...
    public renderDevInfoToHtml(): string{
        let html = `
            <div class="main-content">
                <div class="content-top">
                    <figure class="cover-photo-wrapper">
                        <img src="${this.staticImgUrl}" alt="Cover photo" class="cover-photo">
                    </figure>
                    <p class="level">
                        ${this.getLevel()}
                    </p>
                ...
                <div class="content-bot">
                    <div class="content-comp content-fullname">
                        ...
                        <span class="comp-label comp-name">${this.name}</span>
                    </div>
                    <div class="content-comp content-id">
                        ...
                        <span class="comp-label comp-id">${this.studentId}</span>
                    </div>
                    <div class="content-comp content-class">
                        ...
                        <span class="comp-label comp-class">${this.class}</span>
                    </div>
                    <div class="content-comp content-email">
                        ...
                        <span class="comp-label comp-email">${this.email}</span>
                    </div>
...
function renderAllDevInfoToHtml(devArr: Developer[]): string{
    let html = ''
